...
export const BlogMeta: Metadata = {
  ...
  description:' Example: "Explore the latest luxury furniture trends and expert design tips for your home. Discover how to elevate your interior with Luxe Furniture insights..',
  ...
  twitter: {
    ...
    images: [`${BASE_URL}/images/blog/{twitter-image}.jpg`],
