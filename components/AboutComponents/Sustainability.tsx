			...
			<div className='max-w-7xl mx-auto'>
				...
				>
					<h2 className='text-4xl font-bold mb-6'>
						Our <span className='text-primary'>Sustainability</span> Commitment
					</h2>
					<p className='text-lg text-gray-600 max-w-2xl mx-auto'>
						We&apos;re not just making furniture - we&apos;re building a greener
						future. From sustainable sourcing to carbon-neutral shipping, every
						step of our process prioritizes environmental responsibility.
					</p>
				</motion.div>
