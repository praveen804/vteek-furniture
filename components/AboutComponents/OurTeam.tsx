...
const OurTeam: React.FC = () => {
  return (
    <section className="py-20 px-8 bg-gray-50 text-center">
      <h2 className="text-5xl font-bold text-[#FB2E86] mb-4">Meet Our Team</h2>
      ...
      <div className="flex flex-wrap justify-center mt-12 gap-8">
        {teamMembers.map((member, index) => (
          ...
          >
            <div className="w-40 h-40 mx-auto relative overflow-hidden rounded-full border-4 border-[#FB2E86]">
              <Image
                src={member.img}
                alt={member.name}
                fill
            ...
            <div className="flex justify-center gap-6 mt-6 text-[#FB2E86]">
