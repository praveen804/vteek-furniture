  ...
  return (
    <section className="py-16 px-6 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        ...
        >
          Our <span className="text-[#FB2E86]">Story</span>
        </motion.h2>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            <button className="px-6 py-3 bg-[#FB2E86] text-white font-semibold rounded-lg hover:bg-pink-700 transition duration-300">
              Learn More
            </button>
          </motion.div>
          ...
          >
            ...
            <div className="flex items-start space-x-4">
              <div className="p-3 bg-[#FB2E86] rounded-full text-white">
